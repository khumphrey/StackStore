app.controller('UserCtrl', function ($scope, $state, loggedInUser, ReviewFactory) {
    $scope.user = loggedInUser;
    $scope.reviews = [];

    //display --- 
        //all orders of user, 
        //all reviews by user, basic user info (have an editable button and all the user to edit)
